...
require('lazy').setup({
  ...
  { 'numToStr/Comment.nvim', opts = {} }, -- TODO: LEARN
  ...
  { -- Adds git related signs to the gutter, as well as utilities for managing changes
    'lewis6991/gitsigns.nvim', -- TODO: LEARN
    opts = {
      signs = {
        add = { text = '+' },
        change = { text = '~' },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sh', builtin.help_tags, { desc = '[S]earch [H]elp' }) -- TODO: LEARN
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('K', vim.lsp.buf.hover, 'Hover Documentation') -- TODO: LEARN
      ...
      local servers = {
        ...
        eslint = {},
        tailwindcss = {},
        stylelint_lsp = {}, -- scss and and css in js
        cssls = {}, -- css and css in js
...

  {
    ...
    config = function()
      ...
      -- Set the custom highlight for LineNr and CursorLineNr
      vim.api.nvim_command('highlight LineNr guifg=#FFA500')
